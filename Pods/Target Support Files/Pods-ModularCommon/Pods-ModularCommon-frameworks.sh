...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ModuleResource/ModuleResource.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SLEmptyPage/SLEmptyPage.framework"
  install_framework "${PODS_ROOT}/SLJGSDK/Products/SLJGSDK.framework"
