...
open class BaseViewController: GeneralViewController {
    ...
    /// 自定义导航栏
    public private(set) lazy var naviBar: CommNavigationBar = {
...
extension BaseViewController {
     ...
     */
    @objc open func setNoNetworkPage() {
    ...
    /// 无网络页面点击重新加载
    @objc open func noNetworkPageRefreshAction() {
