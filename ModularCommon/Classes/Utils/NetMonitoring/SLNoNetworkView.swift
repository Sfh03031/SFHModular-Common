...
public class SLNoNetworkView: UIView {

    @objc public var refreshEvent: (() -> Void)?

    @objc static func loadView(_ refreshEvent: (() -> Void)?) -> SLNoNetworkView {
        let view = SLNoNetworkView.sl_loadNib() as? SLNoNetworkView
//            Bundle.main.loadNibNamed("\(self)", owner: nil, options: nil)?.first as? SLNoNetworkView
